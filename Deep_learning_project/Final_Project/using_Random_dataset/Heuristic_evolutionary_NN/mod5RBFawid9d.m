function [highest_accuracy,population,Individual_index] =  mod5RBFawid9d(f,rows1,x1,y,iter);
% %3 hidden Layer MLP
...
%             uu4 = [uu4; ones(1,f)];
            ...
            vv1 = h3(1:end-1,:)'*(1-h3(1:end-1,:))*h2(1:end-1,:)'*(1-h2(1:end-1,:));
...
%             vv4 = [vv4; ones(1,f)];
            ...
            qq1 = h3(1:end-1,:)'*(1-h3(1:end-1,:))*h2(1:end-1,:)'*(1-h2(1:end-1,:))*h1(1:end-1,:)'*(1-h1(1:end-1,:));
...
%             W1l = W1l';
            W2 = W2';
            Weight_matrix = [W1',W1a',W1b',W2'];
            Weight_matrix = [W1',W1a',W1b',W2'].*connection_matrix;
            new_h11_3(m) = h11_3;
            new_y(m) = y(m);
%             test1 = [new_h11_3 y(m)];
 end
