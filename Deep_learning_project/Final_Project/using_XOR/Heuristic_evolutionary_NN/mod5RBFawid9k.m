function [highest_accuracy,population,Individual_index] =  mod5RBFawid9k(f,rows1,x1,y,iter);
%5 hidden Layer MLP

% close all;clear all;clc;
% iter = 5;
% f = 29;   %Number of features in dataset
...
%             W1l = W1l';
            W2 = W2';
            Weight_matrix = [W1',W1a',W1b',W1c',W1d',W1e',W2'];
            Weight_matrix = [W1',W1a',W1b',W1c',W1d',W1e',W2'].*connection_matrix;
            new_h11_3(m) = h11_3;
            new_y(m) = y(m);
            test1 = [new_h11_3 y(m)];
  end
